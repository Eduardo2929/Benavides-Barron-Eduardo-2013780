// Avanze EBB.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
int opcion;
int b, cita, hora, minuto, p, t, resul;
...
int main()
{
    ...
    while (1 == 1) {
        ...
        case 1:
            ...
            cout << "\n\nFavor de escribir su precio unitario\n";
            cin >> p;
            cout << "\n\nFavor de escribit la cantidad del tratamiento deseada\n";
            cin >> t;
            resul = p / t;
            cout << "\n\nEn base con sus datos, este seria su total:\n" << endl << resul << endl;
            system("pause");
        ...
        case 3:
            ...
            if (b == 1)
            {
                ...
                system("pause");
                cout << "\n\nCita Eliminda, Que tenga un buen dia! :)\n";
                system("pause");
                break;
            }
            else
